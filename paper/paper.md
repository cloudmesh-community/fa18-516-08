...
:o: this is not an introduction, but an explanation what is covered, which is fine. But so far there is no information covered, and we may need to discuss if this shuld be changed or deleted. we also need a learning outcome section as we use in other epubs. 
